...
document.getElementById('contact-form').addEventListener('submit', function (e) {
  ...
  const subject = document.getElementById('subject').value.trim() || 'New Portfolio Contact Message';
  ...
  // Actual send via FormSubmit AJAX API
  fetch("https://formsubmit.co/ajax/vigneshwaranvicky9091@gmail.com", {
    method: "POST",
    headers: { 
